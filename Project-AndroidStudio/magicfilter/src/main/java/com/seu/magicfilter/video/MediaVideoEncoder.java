...
public class MediaVideoEncoder extends MediaEncoder {
	...
	public MediaVideoEncoder(final MediaMuxerWrapper muxer, final MediaEncoderListener listener, final int width, final int height) {
		...
		mWidth = width;
		mHeight = height;
		mRenderHandler = RenderHandler.createHandler(TAG, width, height);
	}
	...
	public boolean frameAvailableSoon(final int texid,SurfaceTexture surfaceTexture) {
		boolean result;

		if (result = super.frameAvailableSoon())
			mRenderHandler.draw(texid,surfaceTexture);
		return result;
	}
